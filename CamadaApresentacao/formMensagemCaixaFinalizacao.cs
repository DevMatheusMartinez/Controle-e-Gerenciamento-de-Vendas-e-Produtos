...
namespace CamadaApresentacao
{
    public partial class formMensagemCaixaFinalizacao : Form
    {
        ...
        public formMensagemCaixaFinalizacao(decimal precototallista, string datapedido, string vencimento, int cliente, formFinalizacaoVenda pai, DataGridView datagrid)
        {
            InitializeComponent();
        ...
        {
            string resp = "", resp2 = "";
            resp = NFicha.InserirFicha("Ficha " + Convert.ToString(NFicha.CarregarUltimoIdFicha() + 1), _precototallista, _datapedido, _datapedido, _vencimento, "Pago", _cliente);
